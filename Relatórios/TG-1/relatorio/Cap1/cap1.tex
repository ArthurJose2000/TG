...
It is worth to mention that there is a subdomain of graph data type called tree. A tree is also a abstract data type, which can be represented topologically as a hierarchical structure of nodes. In fact, a tree is a subset of graph theory, therefore a tree is a graph under a different perspective. In Section \ref{section_models_maze}, a tree topology perspective of a maze will be explored.
