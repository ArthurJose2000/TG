...
\citen{Beisel2014} \textit{Distributed Maze Solving By Cooperative Robotic Platforms}

Mainly considering these previous references, the next section intends to define common terms about maze-solving algorithms and graph theory. Furthermore, the next section also intends to clarify the approach domain of this work.
