...
For instance, if $x$ is represented by $1_{2}3_{9}5_{6}$, $x$ might be transformed to decimal base by the following steps:
...
Despite the aforementioned perspective, this work presents a slightly different approach in Section \ref{section_models_mixed_radix}, since it uses a mixed radix representation for numbers contained in the real range $[0,1]$.
